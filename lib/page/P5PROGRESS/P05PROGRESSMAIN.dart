                            ...
                            children: [
                              ShaderMask(
                                ...
                                child: TweenAnimationBuilder<double>(
                                  tween: Tween<double>(
                                    begin:
                                        P05PROGRESSVAR.isHoveredClear ? 8 : 10,
                                    end: P05PROGRESSVAR.isHoveredClear ? 10 : 8,
                                  ),
                                  duration: Duration(milliseconds: 200),
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Container(
                          height: max(adjustedGroupADataCount * 20, 0.5) - 0.5,
                          width: 30,
                          decoration: BoxDecoration(
                            border: Border(
                              top: BorderSide(
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Center(
                                            child: Text(
                                              MEDIUMVisitActualCount.toString(),
                                              style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 10,
                                              ),
