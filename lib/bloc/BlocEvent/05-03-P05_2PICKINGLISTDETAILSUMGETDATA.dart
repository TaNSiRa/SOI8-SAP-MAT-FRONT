...
import '../../page/P5_2PICKINGLISTDETAILSUM/P05_2PICKINGLISTDETAILSUMMAIN.dart';
import '../../page/P5_2PICKINGLISTDETAILSUM/P05_2PICKINGLISTDETAILSUMVAR.dart';
import '../../widget/common/ErrorPopup.dart';
import '../../widget/common/Loading.dart';

//-------------------------------------------------

abstract class P05_2PICKINGLISTDETAILSUMGETDATA_Event {}

class P05_2PICKINGLISTDETAILSUMGETDATA_GET
    extends P05_2PICKINGLISTDETAILSUMGETDATA_Event {}

List<dynamic> dataHead = [];

class P05_2PICKINGLISTDETAILSUMGETDATA_Bloc extends Bloc<
    P05_2PICKINGLISTDETAILSUMGETDATA_Event,
    List<P05_2PICKINGLISTDETAILSUMGETDATAclass>> {
  P05_2PICKINGLISTDETAILSUMGETDATA_Bloc() : super([]) {
    on<P05_2PICKINGLISTDETAILSUMGETDATA_GET>((event, emit) {
      return _P05_2PICKINGLISTDETAILSUMGETDATA_GET([], emit);
    });
  }

  Future<void> _P05_2PICKINGLISTDETAILSUMGETDATA_GET(
      List<P05_2PICKINGLISTDETAILSUMGETDATAclass> toAdd,
      Emitter<List<P05_2PICKINGLISTDETAILSUMGETDATAclass>> emit) async {
    print('IN : P05_2PICKINGLISTDETAILSUMGETDATA_GET');
    FreeLoadingTan(P05_2PICKINGLISTDETAILSUMMAINcontext);
    List<P05_2PICKINGLISTDETAILSUMGETDATAclass> output = [];
    //-------------------------------------------------------------------------------------
    try {
      ...
      final response = await Dio().post(
        ...
        data: {
          ...
          'searchDate': P05PICKINGLISTVAR.searchDate,
          'userData': {
            'Id': USERDATA.ID,
            'Name': USERDATA.NAME,
          },
      ...
      if (response.statusCode == 200) {
        ...
        List<P05_2PICKINGLISTDETAILSUMGETDATAclass> outputdata =
            input.map((dataActual) {
          return P05_2PICKINGLISTDETAILSUMGETDATAclass(
        ...
        Navigator.pop(P05_2PICKINGLISTDETAILSUMMAINcontext);
        output = outputdata;
        emit(output);
      } else {
        ...
        Navigator.pop(P05_2PICKINGLISTDETAILSUMMAINcontext);
        showErrorPopup(
            P05_2PICKINGLISTDETAILSUMMAINcontext, response.toString());
        output = [];
        emit(output);
      }
    } catch (e) {
      print(e);
      Navigator.pop(P05_2PICKINGLISTDETAILSUMMAINcontext);
      showErrorPopup(P05_2PICKINGLISTDETAILSUMMAINcontext, e.toString());
      output = [];
      emit(output);
    }
  }
...
class P05_2PICKINGLISTDETAILSUMGETDATAclass {
  P05_2PICKINGLISTDETAILSUMGETDATAclass({
    this.ID = '',
    this.MainOrder = '',
    this.OrderNo = '',
    this.Order_Start_DT = '',
