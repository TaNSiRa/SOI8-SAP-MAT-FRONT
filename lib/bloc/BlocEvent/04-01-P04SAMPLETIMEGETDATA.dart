...
abstract class P04SAMPLETIMEGETDATA_Event {}

class P04SAMPLETIMEGETDATA_GET extends P04SAMPLETIMEGETDATA_Event {}

class P04SAMPLETIMEGETDATA_GET2 extends P04SAMPLETIMEGETDATA_Event {}

class P04SAMPLETIMEGETDATA_GET3 extends P04SAMPLETIMEGETDATA_Event {}

class P04SAMPLETIMEGETDATA_FLUSH extends P04SAMPLETIMEGETDATA_Event {}

class P04SAMPLETIMEGETDATA_Bloc
    extends Bloc<P04SAMPLETIMEGETDATA_Event, List<P04SAMPLETIMEGETDATAclass>> {
  P04SAMPLETIMEGETDATA_Bloc() : super([]) {
    on<P04SAMPLETIMEGETDATA_GET>((event, emit) {
      return _P04SAMPLETIMEGETDATA_GET([], emit);
    });

    on<P04SAMPLETIMEGETDATA_GET2>((event, emit) {
      return _P04SAMPLETIMEGETDATA_GET2([], emit);
    });
    on<P04SAMPLETIMEGETDATA_GET3>((event, emit) {
      return _P04SAMPLETIMEGETDATA_GET3([], emit);
    });
    on<P04SAMPLETIMEGETDATA_FLUSH>((event, emit) {
      return _P04SAMPLETIMEGETDATA_FLUSH([], emit);
    });
  }

  Future<void> _P04SAMPLETIMEGETDATA_GET(List<P04SAMPLETIMEGETDATAclass> toAdd,
      Emitter<List<P04SAMPLETIMEGETDATAclass>> emit) async {
    ...
    final response = await Dio().post(
      ...
      data: {
        ...
        // 'YEAR': P04SAMPLETIMEVAR.DropDownYear.toString(),
      },
    );
    var input = [];
    if (response.statusCode == 200) {
      ...
      List<P04SAMPLETIMEGETDATAclass> outputdata = input.map((data) {
        return P04SAMPLETIMEGETDATAclass(
  ...
  Future<void> _P04SAMPLETIMEGETDATA_GET2(List<P04SAMPLETIMEGETDATAclass> toAdd,
      Emitter<List<P04SAMPLETIMEGETDATAclass>> emit) async {
    // List<P04SAMPLETIMEGETDATAclass> output = [];
    //-------------------------------------------------------------------------------------
    // var input = dummydatainput2;

    // List<P04SAMPLETIMEGETDATAclass> outputdata = input
    //     .where((data) =>
    //         data['location'] == 'ESIE1' &&
    //         data['plant'] == 'YES' &&
    //         data['step01'] == 'YES')
  ...
  Future<void> _P04SAMPLETIMEGETDATA_GET3(List<P04SAMPLETIMEGETDATAclass> toAdd,
      Emitter<List<P04SAMPLETIMEGETDATAclass>> emit) async {
    // List<P04SAMPLETIMEGETDATAclass> output = [];
    //-------------------------------------------------------------------------------------
    // List<P04SAMPLETIMEGETDATAclass> datadummy = [
    //   P04SAMPLETIMEGETDATAclass(
    //     PLANT: "PH PO:1234",
    //     STEP01: "YES",
    //     STEP02: "YES",
    //     STEP03: "YES",
  ...
  Future<void> _P04SAMPLETIMEGETDATA_FLUSH(
      List<P04SAMPLETIMEGETDATAclass> toAdd,
      Emitter<List<P04SAMPLETIMEGETDATAclass>> emit) async {
    List<P04SAMPLETIMEGETDATAclass> output = [];
    emit(output);
  }
...
class P04SAMPLETIMEGETDATAclass {
  P04SAMPLETIMEGETDATAclass({
    this.TYPE = '',
    this.MKTGROUP = '',
    this.GROUP = '',
