...
abstract class P06TABLEREPORTOVERDUEGETDATA_Event {}

class P06TABLEREPORTOVERDUEGETDATA_GET
    extends P06TABLEREPORTOVERDUEGETDATA_Event {}

class P06TABLEREPORTOVERDUEGETDATA_GET2
    extends P06TABLEREPORTOVERDUEGETDATA_Event {}

class P06TABLEREPORTOVERDUEGETDATA_GET3
    extends P06TABLEREPORTOVERDUEGETDATA_Event {}

class P06TABLEREPORTOVERDUEGETDATA_FLUSH
    extends P06TABLEREPORTOVERDUEGETDATA_Event {}

class P06TABLEREPORTOVERDUEGETDATA_Bloc extends Bloc<
    P06TABLEREPORTOVERDUEGETDATA_Event,
    List<P06TABLEREPORTOVERDUEGETDATAclass>> {
  P06TABLEREPORTOVERDUEGETDATA_Bloc() : super([]) {
    on<P06TABLEREPORTOVERDUEGETDATA_GET>((event, emit) {
      return _P06TABLEREPORTOVERDUEGETDATA_GET([], emit);
    });

    on<P06TABLEREPORTOVERDUEGETDATA_GET2>((event, emit) {
      return _P06TABLEREPORTOVERDUEGETDATA_GET2([], emit);
    });
    on<P06TABLEREPORTOVERDUEGETDATA_GET3>((event, emit) {
      return _P06TABLEREPORTOVERDUEGETDATA_GET3([], emit);
    });
    on<P06TABLEREPORTOVERDUEGETDATA_FLUSH>((event, emit) {
      return _P06TABLEREPORTOVERDUEGETDATA_FLUSH([], emit);
    });
  }

  Future<void> _P06TABLEREPORTOVERDUEGETDATA_GET(
      List<P06TABLEREPORTOVERDUEGETDATAclass> toAdd,
      Emitter<List<P06TABLEREPORTOVERDUEGETDATAclass>> emit) async {
    FreeLoadingTan(P06TABLEREPORTOVERDUEMAINcontext);
    List<P06TABLEREPORTOVERDUEGETDATAclass> output = [];
    //-------------------------------------------------------------------------------------
    final response = await Dio().post(
      "http://127.0.0.1:14000/02SARKPI/OverdueSelect",
      data: {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pop(P06TABLEREPORTOVERDUEMAINcontext);
  ...
  Future<void> _P06TABLEREPORTOVERDUEGETDATA_GET2(
      List<P06TABLEREPORTOVERDUEGETDATAclass> toAdd,
      Emitter<List<P06TABLEREPORTOVERDUEGETDATAclass>> emit) async {
    // List<P06TABLEREPORTOVERDUEGETDATAclass> output = [];
    //-------------------------------------------------------------------------------------
    ...
    // List<P06TABLEREPORTOVERDUEGETDATAclass> outputdata = input
    //     .where((data) =>
    //         data['location'] == 'ESIE1' &&
    //         data['plant'] == 'YES' &&
    //         data['step01'] == 'YES')
  ...
  Future<void> _P06TABLEREPORTOVERDUEGETDATA_GET3(
      List<P06TABLEREPORTOVERDUEGETDATAclass> toAdd,
      Emitter<List<P06TABLEREPORTOVERDUEGETDATAclass>> emit) async {
    // List<P06TABLEREPORTOVERDUEGETDATAclass> output = [];
    //-------------------------------------------------------------------------------------
    // List<P06TABLEREPORTOVERDUEGETDATAclass> datadummy = [
    //   P06TABLEREPORTOVERDUEGETDATAclass(
    //     PLANT: "PH PO:1234",
    //     STEP01: "YES",
    //     STEP02: "YES",
    //     STEP03: "YES",
  ...
  Future<void> _P06TABLEREPORTOVERDUEGETDATA_FLUSH(
      List<P06TABLEREPORTOVERDUEGETDATAclass> toAdd,
      Emitter<List<P06TABLEREPORTOVERDUEGETDATAclass>> emit) async {
    List<P06TABLEREPORTOVERDUEGETDATAclass> output = [];
    emit(output);
...
class P06TABLEREPORTOVERDUEGETDATAclass {
  P06TABLEREPORTOVERDUEGETDATAclass({
    this.TYPE = '',
    this.MKTGROUP = '',
    this.GROUP = '',
